...
contract SupplyChain {
 ...
 mapping (uint => Item) items;
  ...
  modifier sold(uint _sku) {
    require(items[_sku].state == State.Sold, "This item hasn't been sold.");
    _;
  } 
   modifier shipped(uint _sku) {
    require(items[_sku].state == State.Shipped, "This item hasn't shipped yet.");
    _;
  } 
  modifier received(uint _sku) {
    require(items[_sku].state == State.Received, "This item hasn't been received yet.");
    _;
  }
